...
-- CreateEnum
CREATE TYPE "SiteAssetType" AS ENUM ('HERO_BANNER', 'PROMO_BANNER', 'POSTER', 'PAYMENT_QR', 'LOGO');
...
-- CreateIndex
CREATE INDEX "SiteAsset_type_isActive_idx" ON "SiteAsset"("type", "isActive");
...
-- AddForeignKey
ALTER TABLE "SiteAsset" ADD CONSTRAINT "SiteAsset_uploadedById_fkey" FOREIGN KEY ("uploadedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
